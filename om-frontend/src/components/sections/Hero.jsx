...
const colA = [
  { video: "https://bylqrtnrbsniwsaursaz.supabase.co/storage/v1/object/public/ORBIT%20MEDIA/0521(1).mp4", name: "visual.ayush", instagramUrl: "https://www.instagram.com/visual.ayush/" },
  { video: "https://bylqrtnrbsniwsaursaz.supabase.co/storage/v1/object/public/ORBIT%20MEDIA/4.mp4", name: "elevatorgoods", instagramUrl: "https://www.instagram.com/elevatorgoods/" },
  { video: "https://bylqrtnrbsniwsaursaz.supabase.co/storage/v1/object/public/ORBIT%20MEDIA/3.mp4", name: "Orbit Media", instagramUrl: "https://www.instagram.com/orbit.media.in/" },
];

const colB = [
  { video: "https://bylqrtnrbsniwsaursaz.supabase.co/storage/v1/object/public/ORBIT%20MEDIA/5.mp4", name: "thenextbigthing_media", instagramUrl: "https://www.instagram.com/thenextbigthing_media/" },
  { video: "https://bylqrtnrbsniwsaursaz.supabase.co/storage/v1/object/public/ORBIT%20MEDIA/1.mp4", name: "ace.me", nameStyle: "serif", instagramUrl: "https://www.instagram.com/acedotme/" },
  { video: "https://bylqrtnrbsniwsaursaz.supabase.co/storage/v1/object/public/ORBIT%20MEDIA/6.mp4", name: "Refly Official", instagramUrl: "https://www.instagram.com/reflyofficial/" },
];

export default function Hero() {
  return (
    <div className="min-h-screen text-white" style={{ background: "#09051a" }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:wght@400;500;600;700;800&family=Caveat:wght@500;700&display=swap');

        .hero-root { font-family: 'Bricolage Grotesque', sans-serif; }
      ...
      <main className="hero-root relative">
        {/* Grid bg */}
        <div
          aria-hidden="true"
        ...
        <div className="mx-auto px-10 lg:px-[140px] relative grid lg:grid-cols-2 gap-12 lg:gap-16 items-stretch pt-12 pb-24 lg:pt-0 lg:pb-0">

          {/* Left: copy */}
          <div className="flex flex-col justify-center lg:min-h-[calc(100vh-5rem)] lg:py-16">
            <h1
              className="text-[64px] leading-[0.95] font-black tracking-[-0.04em] text-white max-w-[780px]"
              style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}
            >
              Helping{" "}
              <span style={{ color: "#a78bfa" }}>Entrepreneurs</span>
              <br />
              build{" "}
              <em
                style={{
              ...
              <br />
              brands as{" "}
              <span className="relative inline-block" style={{ color: "#a78bfa" }}>
                niche authorities
                <svg
            ...
            <p className="mt-10 max-w-[560px] text-[17px] leading-[1.7] font-medium" style={{ color: "#9ca3af" }}>
              Scaling brands for niche authorities with world class organic content.
              Currently working with personal brands, funded startups, Crypto/trading
            ...
            <div className="mt-8 flex items-center gap-5">
              <a
                href="#contact"
                className="inline-block text-white font-semibold px-8 py-4 rounded-xl transition no-underline"
                style={{
              ...
              <div className="relative">
                <span
                  className="text-2xl inline-block -rotate-[12deg]"
                  style={{ fontFamily: "'Caveat', cursive", color: "#a78bfa" }}
                >
                  It's Free
                </span>
                <svg
                  className="absolute -bottom-4 -left-2 w-12 h-8"
                  style={{ transform: "scaleX(-1)", color: "#7c3aed" }}
                  viewBox="0 0 48 32"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
          ...
          <div className="lg:h-[calc(100vh-5rem)] lg:overflow-hidden relative">
            ...
            <div className="hidden lg:grid grid-cols-2 gap-4 h-full">
              ...
              <div className="pointer-events-none absolute inset-x-0 top-0 h-16 col-span-2" style={{ background: "linear-gradient(to bottom, #09051a, transparent)" }} />
              <div className="pointer-events-none absolute inset-x-0 bottom-0 h-16 col-span-2" style={{ background: "linear-gradient(to top, #09051a, transparent)" }} />
            </div>
          </div>
