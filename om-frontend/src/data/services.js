export const services = [
  ...
  },
  {
    ...
    shortDescription:
      "Animated explainers, kinetic typography, and branded motion design that make complex ideas easy to watch — built to elevate everything from product demos to social content.",
    included: [
      "Custom animated explainer & product videos",
      "Kinetic typography & lyric/quote videos",
      "Animated logos, intros & lower-thirds",
      "Motion design systems for recurring content",
    ],
    videos: [
      "https://res.cloudinary.com/db2ehmua9/video/upload/v1782064567/This_guy_built_a_1.8_billion_company_with_2_employees.No_developers._No_VC._No_extra_team.Matth_p5pttx.mp4",
      "https://res.cloudinary.com/db2ehmua9/video/upload/v1782064559/How_to_create_websites_with_ace.me_in_5_simple_steps_mh1y8a.mp4",
